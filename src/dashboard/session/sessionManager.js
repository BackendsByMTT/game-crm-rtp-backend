...
class SessionManager {
    constructor() {
        ...
        this.cleanupStaleSessions = () => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.endGame = (username) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield sessionModel_1.PlatformSessionModel.updateOne({ playerId: player.playerData.username, entryTime: player.entryTime }, { $push: { gameSessions: (_a = player.currentGameSession) === null || _a === void 0 ? void 0 : _a.getSummary() }, $set: { currentRTP: player.currentRTP } });
            ...
            try {
                ...
                if (sessionData.currentGame && sessionData.currentGame !== "null") {
                    try {
                        ...
                        player.currentGameData.currentGameManager = new GameManager_1.default(player.currentGameData);
                        // ✅ Restore the GameSession instance
                        player.currentGameSession = new gameSession_1.GameSession(sessionData.playerId, gameData.gameId, parseFloat(sessionData.currentCredits));
