...
app.get('/health', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const healthInfo = {
        ...
        workers: cluster_1.default.isWorker ? `Worker ID: ${cluster_1.default.worker.id}` : 'Master Process',
        database: {
...
(0, db_1.default)().then(() => {
    ...
    if (!sticky_session_1.default.listen(server, Number(config_1.config.port))) {
        // Master Process
        server.once("listening", () => console.log(`🚀 Server started on port ${config_1.config.port}`));
    }
    else {
