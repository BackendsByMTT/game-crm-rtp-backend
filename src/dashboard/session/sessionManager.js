    ...
    constructor() {
        ...
        this.endSession = (username) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // ❌ Update MongoDB
                yield sessionModel_1.PlatformSessionModel.updateOne({ playerId: player.playerData.username, sessionId: player.sessionId }, { $set: { exitTime: new Date() } });
        ...
        this.endGame = (username) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (player.currentGameSession) {
                    ...
                    yield sessionModel_1.PlatformSessionModel.updateOne({ playerId: player.playerData.username, sessionId: player.sessionId }, {
    ...
    restoreSessionFromRedis(sessionData, socket) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                player.sessionId = sessionData.sessionId || (0, uuid_1.v4)(); // Use existing or fallback
                ...
                // ✅ Restart heartbeat
                this.startSessionHeartbeat(player);
                yield this.notify(sessionData.playerId, events_1.Events.PLAYGROUND_GAME_ENTER, player.currentGameSession.getSummary());
