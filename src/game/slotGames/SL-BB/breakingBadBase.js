    ...
    spinResult() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield platformSession.currentGameSession.updateSpinField(spinId, 'winAmount', totalWinAmount);
                ...
                yield platformSession.currentGameSession.updateSpinField(spinId, "specialFeatures", {
